...
G.add_edge("SportsComplex", "Siwaka", weight="0.450")
G.add_edge("Siwaka", "Ph.1A", weight="0.010")
G.add_edge("Siwaka", "Ph.1B", weight="0.230")
G.add_edge("Ph.1A", "Mada", weight="0.850")
G.add_edge("Ph.1B", "Phase2", weight="0.112")
G.add_edge("Ph.1B", "STC", weight="0.500")
G.add_edge("Phase2", "J1", weight="0.600")
G.add_edge("J1", "Mada", weight="0.200")
G.add_edge("Phase3", "ParkingLot", weight="0.350")
G.add_edge("Phase2", "Phase3", weight="0.500")
G.add_edge("STC", "ParkingLot", weight="0.250")
G.add_edge("ParkingLot", "Mada", weight="0.700")
G.add_edge("Phase2", "STC", weight="0.050")
G.add_edge("Ph.1A", "Ph.1B", weight="0.100")
